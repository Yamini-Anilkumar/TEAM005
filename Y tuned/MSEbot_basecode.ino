...
const int ciMotorLeftB = 15;        //old pinout was 18
const int ciMotorRightA = 2;        //old pinout was 19
...
const int ciSmartLED = 25;                    //led hookup?                          
const int ciStepperMotorDir = 22;
const int ciStepperMotorStep = 21;
const int ciNearMot = 18;  //USE 5V
const int ciFarMot = 19;   // USE 5V
...
const uint8_t ci8RightTurn = 26;
const uint8_t ci8LeftTurn = 20;
          ...
          if (btRun)
          {
            ...
            if (CR1_ulMotorTimerNow - CR1_ulMotorTimerPrevious >= CR1_ciMotorRunTime)
            {
              ...
              switch (ucMotorStateIndex)
              {
                case 0:
                  {
                    digitalWrite(ciNearMot, HIGH);      //Motors start running at button push
      ...
      case 3:
        {
          ...
          if (ENC_ISMotorRunning())
          {
            int leftSpeed = 200;
            int rightSpeed = 200;
            MoveTo(ucMotorState, leftSpeed, rightSpeed);
          }
